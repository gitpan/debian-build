if (!defined &_SYS_LOG_H)
{
    eval 'sub _SYS_LOG_H {1;}';
    require 'features.ph';
    ...
    {
	eval 'sub INTERNAL_NOPRI {0x10;}';
	eval 'sub INTERNAL_MARK { &LOG_MAKEPRI( &LOG_NFACILITIES, 0);}';
    }
    ...
    eval 'sub LOG_CRON {(9<<3);}';
    eval 'sub LOG_AUTHPRIV {(10<<3);}';
